...
namespace DotNetJobSeek.Infrastructure.EF.Migrations
{
    ...
    [Migration("20180301043019_selfreference")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DotNetJobSeek.Domain.KeywordNeighbors", b =>
                {
            ...
            modelBuilder.Entity("DotNetJobSeek.Domain.KeywordNeighbors", b =>
                {
                    b.HasOne("DotNetJobSeek.Domain.Keyword", "Left")
                        .WithMany("Lefts")
                        .HasForeignKey("LeftId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("DotNetJobSeek.Domain.Keyword", "Right")
                        .WithMany("Rights")
